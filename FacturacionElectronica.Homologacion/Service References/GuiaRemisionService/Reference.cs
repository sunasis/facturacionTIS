...
namespace FacturacionElectronica.Homologacion.GuiaRemisionService {
    ...
    internal partial class getStatusResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public FacturacionElectronica.Homologacion.GuiaRemisionService.statusResponse status;
        
        public getStatusResponse() {
        }
        
        public getStatusResponse(FacturacionElectronica.Homologacion.GuiaRemisionService.statusResponse status) {
            this.status = status;
        }
    }
    ...
    internal partial class billServiceClient : System.ServiceModel.ClientBase<FacturacionElectronica.Homologacion.GuiaRemisionService.billService>, FacturacionElectronica.Homologacion.GuiaRemisionService.billService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        FacturacionElectronica.Homologacion.GuiaRemisionService.getStatusResponse FacturacionElectronica.Homologacion.GuiaRemisionService.billService.getStatus(FacturacionElectronica.Homologacion.GuiaRemisionService.getStatusRequest request) {
            return base.Channel.getStatus(request);
        }
        
        public FacturacionElectronica.Homologacion.GuiaRemisionService.statusResponse getStatus(string ticket) {
            ...
            FacturacionElectronica.Homologacion.GuiaRemisionService.getStatusResponse retVal = ((FacturacionElectronica.Homologacion.GuiaRemisionService.billService)(this)).getStatus(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        FacturacionElectronica.Homologacion.GuiaRemisionService.sendPackResponse FacturacionElectronica.Homologacion.GuiaRemisionService.billService.sendPack(FacturacionElectronica.Homologacion.GuiaRemisionService.sendPackRequest request) {
        ...
        public string sendPack(string fileName, byte[] contentFile) {
            ...
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            FacturacionElectronica.Homologacion.GuiaRemisionService.sendPackResponse retVal = ((FacturacionElectronica.Homologacion.GuiaRemisionService.billService)(this)).sendPack(inValue);
